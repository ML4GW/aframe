...
You can assign various attributes to your W&B logger by uncommenting and editing the `WandbLogger` entry under `trainer.logger` in `projects/train/train.yaml`
