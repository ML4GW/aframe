...
def main(
    ...
    Args:
        ...
        minimum_frequency:
            Minimum_frequency for generating waveform; not to
        ...
        highpass:
            The frequency to use for a highpass filter
        snr_threshold:
...
def deploy(
    ...
    Args:
        ...
        prior:
            A function that returns a Bilby PriorDict when called
        minimum_frequency:
            Minimum_frequency for generating waveform; not to be confused
            with highpass filter frequency
        reference_frequency:
            Reference frequency for generating waveform
        sample_rate:
            Rate at which to sample time series
